...
const gates = [
  ...
  [npm, ["run", "db:reset"]],
  [npm, ["run", "db:test"]],
  [npm, ["run", "test:e2e:phase6b"]],
  [npm, ["run", "test:phase6b:cleanup"]],
  [npm, ["run", "test:phase6b:security"]],
...
console.log("Phase 6B verification passed. Hosted provider configuration, real transactional email, participant invitations, activation, Production, and billing remain outside this local gate.");
