...
const gates = [
  [npm, ["run", "test:phase8d"]],
  [npm, ["run", "db:reset"]],
  [npm, ["run", "db:test"]],
  [npm, ["run", "test:e2e:phase8a"]],
  [npm, ["run", "test:e2e:phase8d"]],
  [npm, ["run", "test:phase8d:security"]],
  [npm, ["run", "typecheck"]],
  ["git", ["diff", "--check"]],
...
console.log("Phase 8D verification passed. PDF resources are private, validated, review-gated, and delivered only through server authorization.");
