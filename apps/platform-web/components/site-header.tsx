...
export async function SiteHeader() {
  ...
  // two rows (brand | call to action | account menu, then the product grid);
  ...
  // is display:none, outside the accessibility tree. The banner holds the six
  // product destinations only: the authorized-code entry is the homepage form
  // (and the copies on the access and sign-in pages), never a banner item.
  return (
