...
const copy: Record<GameAccessDecision["reason"], { title: string; message: string; tone: "information" | "success" | "warning" }> = {
  ...
  "checkout-required": { title: "Subscription setup required", message: "Add a payment method through the future Stripe-hosted flow to start the one-time 24-hour trial. Billing actions remain disabled in Phase 7B.", tone: "information" },
