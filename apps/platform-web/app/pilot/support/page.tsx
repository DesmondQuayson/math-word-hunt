...
export default function PilotSupportPage() {
  return <PilotShell currentPath="/pilot/support">
    <header className="page-header"><p className="eyebrow">Pilot field guide · support</p><h1>Report the workflow, not the person.</h1><p className="lede">Contact the pilot coordinator using the channel through which pilot access was provided. The operating target is acknowledgment within one business day; this is not 24/7 emergency support.</p></header>
    <AuthEmailStatus label="Account message delivery" />
