...
export default function PilotPrivacyPage() {
  return <PilotShell currentPath="/pilot/privacy">
    ...
    <section className="pilot-rule-grid" aria-labelledby="pilot-collected-heading"><div><p className="eyebrow">Limited collection</p><h2 id="pilot-collected-heading">What the current platform may hold</h2></div><ul><li>Authentication email managed by the identity provider</li><li>Teacher display name and optional organization label</li><li>General class labels and activity drafts</li><li>Account and staged deletion-request state</li><li>Sanitized, low-cardinality operational events</li></ul></section>
    <section className="pilot-rule-grid pilot-rule-grid-danger" aria-labelledby="pilot-prohibited-heading"><div><p className="eyebrow">Never enter</p><h2 id="pilot-prohibited-heading">What must stay outside</h2></div><ul><li>Student names, emails, IDs, rosters, work, or grades</li><li>IEP, disability, behavioral, or sensitive school information</li><li>Passwords, tokens, cookies, one-time links, or provider secrets</li><li>Payment details, screenshots, files, or raw authentication payloads</li></ul></section>
