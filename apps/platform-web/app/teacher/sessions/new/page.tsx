...
export default function NewSessionPage() {
  return (
    <TeacherShell currentPath="/teacher/sessions/new">
      ...
      <PageHeader
        eyebrow="Live-session preview · Service unavailable"
      ...
      <div className="session-boundary-grid">
        <Card variant="highlighted" className="session-boundary-card">
          ...
          <p>The current v7 game is the only live classroom option available now.</p>
        ...
        <Card variant="muted" className="session-boundary-card">
          ...
          <p id="managed-session-disabled" className="disabled-explanation">Unavailable until account and live-session services are ready.</p>
        </Card>
      </div>
