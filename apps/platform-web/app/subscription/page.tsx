...
export default async function SubscriptionPage({ searchParams }: { searchParams: Promise<{ billing?: string; checkout?: string; consent?: string; next?: string }> }) {
  ...
  return <Container className="page-stack" width="compact">
    ...
    <Notice label="Included with your subscription" tone="information"><strong>One MathNexa subscription includes Math Games, Online Math Prep, Homework PDFs, and Quiz PDFs.</strong><p>Every included area uses the same server-verified trial or subscription. You will not be asked to subscribe again for another module.</p></Notice>
