...
export default async function QuizzesPage(){await requireProductAccess("/quizzes");return <Container className="page-stack" width="wide"><PublicResourceLibrary kind="quizzes" resources={await loadPublicResourceCatalog("quizzes")}/></Container>;}
